...
public class Trig
{
    ...
    public void Sin()
    {
        ...
        var num6 = new Equation("sin(360)").Solve().Real;
    ...
    public void Sinh()
    {
        ...
        Equation.Radians = false;
        var num5 = new Equation("sinh(pi)").Solve().Real;
        Equation.Radians = true;

        Assert.AreEqual(num1, num5); //radians/degrees does not matter for hyperbolic
    ...
    public void Asin()
    {
        ...
        Equation.Radians = false;
        var num5 = new Equation("asin(1)").Solve().Real;
        Equation.Radians = true;
    ...
    public void Cos()
    {
        ...
        Equation.Radians = false;
        var num5 = new Equation("cos(360)").Solve().Real;
        Equation.Radians = true;
    ...
    public void Cosh()
    {
        ...
        Equation.Radians = false;
        var num5 = new Equation("cosh(pi)").Solve().Real;
        Equation.Radians = true;
    ...
    public void Acos()
    {
        ...
        Equation.Radians = false;
        var num5 = new Equation("acos(1)").Solve().Real;
        Equation.Radians = true;
    ...
    public void Tan()
    {
        ...
        Equation.Radians = false;
        var num4 = new Equation("tan(45)").Solve().Real;
        Equation.Radians = true;
    ...
    {
        Equation.Radians = false;
        var num4 = new Equation("tanh(pi)").Solve().Real;
        Equation.Radians = true;
        ...
        Assert.AreEqual(num1, num4); //radians/degrees does not matter for hyperbolic
        ...
        Assert.IsTrue(Equation.Radians);
    }
    ...
    public void Atan()
    {
        ...
        Equation.Radians = false;
        var num5 = new Equation("atan(1)").Solve().Real;
        Equation.Radians = true;
